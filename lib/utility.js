...
var _crudObjectDiff = require("crud-object-diff");
...
var combineReducers = function combineReducers(reducers) {
  ...
  return [function (state, action) {
    ...
    for (var i = 0; i < reducerKeys.length; i++) {
      ...
      hasStateChanged = hasStateChanged || !(0, _crudObjectDiff.isEqualObject)(nextStateForCurrentKey, prevStateForCurrentKey);
