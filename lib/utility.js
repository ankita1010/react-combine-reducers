...
var combineReducers = function combineReducers(reducers) {
  ...
  reducerKeys.forEach(function (key, index) {
    globalState = _objectSpread({}, globalState, _defineProperty({}, key, reducerValues[index][1]));
  });
  var finalReducers = {};
  reducerValues.forEach(function (value, index) {
    finalReducers = _objectSpread({}, finalReducers, _defineProperty({}, reducerKeys[index], value[0]));
  });
